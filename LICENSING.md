...
| [`openlibrary-bots`](https://github.com/agentic-commons-foundation/openlibrary-bots) | Source code (fork) | Unresolved | ⏳ Under review (upstream `openlibrary-client` license) |
